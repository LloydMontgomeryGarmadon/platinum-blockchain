...
Write-Output ""
Write-Output "Try the Quick Start Guide to running platinum-blockchain:"
Write-Output "https://github.com/Chia-Network/platinum-blockchain/wiki/Quick-Start-Guide"
Write-Output ""
