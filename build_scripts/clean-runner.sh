...
rm -rf ../venv || true
rm -rf venv || true
rm -rf platinum_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf platinum-blockchain-gui/build || true
rm -rf platinum-blockchain-gui/daemon || true
rm -rf platinum-blockchain-gui/node_modules || true
rm platinum-blockchain-gui/temp.json || true
( cd "$PWD/platinum-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
